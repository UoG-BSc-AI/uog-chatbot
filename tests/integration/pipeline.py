...
def generate_response_ollama_llama3(prompt):
...
if __name__ == "__main__":
    ...
    df["response"] = df["Query"].apply(lambda x: generate_response_ollama_llama3(x))
    df.to_csv("../../data/experiments/experiments_ollama_llama3.csv", index=None)
