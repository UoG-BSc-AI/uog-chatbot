...
# New after testing and debugging
...
patterns_responses = {
    ...
    r"what is your name.*": [
        "Hey, my name is Cecil the Chatbot, and I'm here to assist you!"
    ],
    r"what is the university of gloucestershire.*": [
    ...
    r"when was the business school opened.*": [
        "The business school was opened in 2018."
    ],
    r"how much did the business school cost.*": [
        "The business school cost £18 million."
    ],
    r"give me a brief description of the business school.*": [
        "Opened in 2018, this new £18 million development features an impressive atrium, boardroom, state-of-the-art lecture rooms along with the following specialist spaces: Thomas Reuters trading room, Consumer behaviour lab, Moot court room, Growth Hub."
    ],
    r"Give me information about the performing arts centre .*": [
        "This £2million facility is purpose-built with transformative studios to accommodate any performance."
    ],
    r"Give me information about the health social care facilities .*": [
        "Our new dedicated facilities and equipment allow students to prepare for the frontline of healthcare and learn the very cutting-edge techniques."
    ],
    ...
    r"What is oxstalls campus .*": [
        "This is a high-energy campus of forward-thinking and competitive students. Here, our students train for the frontline of healthcare, perform and produce shows, work alongside elite athletes and make connections with global businesses. Located 15 mins’ walk from Gloucester city centre and Kingsholm rugby stadium, you’ll have easy access to clubs, bars, shops, theatres and cafes."
    ],
    r"Are there green spaces at oxstalls campus .*": [
        "The campus is surrounded by ponds and green spaces, or nearby is the new area and surrounding pitches where our students can be found competing or just playing for fun."
    ],
    r"Is there food drink at oxstalls campus .*": [
        "The campus’ refectory offers hot meals, snacks, fresh sandwiches, a salad bar and freshly baked cakes and pastries. There are vegan and vegetarian options available as well as vending machines and free water stations, so you can top up your bottle."
    ],
    r"Are there illustration architecture studios .*": [
        "These open-plan studios offer a bespoke space for each student to develop their individual style. We’re expanding the studios for the launch of our brand-new Architecture, Construction & Environment subject community."
    ],
    r"Tell me about the hardwick centre fine art photography .*": [
        "Just a few minutes’ walk from the main campus is a thriving hub of creativity for our fine art and photography students. It offers year-round exhibitions in the gallery, including our own third-year Degree Show, where students showcase their work to visiting artists and the public."
    ],
    r"Tell me about the education humanities facilities .*": [
        "Whether you’re the next generation of teachers and carers, campaigning for social change or putting your passion into words – these historic grounds offer modern facilities for our students to debate, research and train."
    ],
    r"What is the natural social sciences facilities .*": [
    ...
    r"Are there green spaces at francis close hall .*": [
    ...
    r"Is there food and drink at campus .*": [
    ...
    r"Tell me about the computing engineering centre .*": [
        "These state-of-the-art facilities offer the very latest hardware and software for our students to experiment and innovate."
    ],
    r"What is the design centre .*": [
        "Our brand-new centre offers bespoke professional spaces for our design students to develop their creative talent. Each studio is unique and you’ll find student designs painted on some of the walls."
    ],
    r"What is the media centre .*": [
        "With top-spec facilities, this interdisciplinary hub provides a professional space where students can commission, collaborate and create together."
    ],
    r"What is park campus .*": [
        "These beautiful grounds offer a creative hub for our art, media and technology students to collaborate and inspire each other. Set in the Montpellier district of the town, the campus has a real buzz, surrounded by Georgian villas, botanical gardens, bars and boutiques."
    ],
    r"Are there green spaces at park campus .*": [
        "Originally laid out as a zoological garden, with its own lake and elephant walkway, Park Campus is surrounded by picturesque parklands. It has MUGA pitches and acres of green for students to hang out. In view from the campus are the stunning Cotswold Hills. The Cotswolds are the largest Area of Outstanding Natural Beauty (AONB) in the UK."
    ],
    r"What food and drink does park campus offer .*": [
...
conversation_text = scrolledtext.ScrolledText(
    root, wrap=tk.WORD, height=20, font=("Arial", 12)
)
