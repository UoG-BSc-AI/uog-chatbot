...
# TODO: Implemented choice between Ollama and OpenAI models. (uses ollama if no key is entered)
...
st.set_page_config(
    page_title="University of Gloucestershire Chatbot", page_icon="🎓", layout="wide"
)
...
def main():
    ...
    st.markdown(
        "[GitBook Documentation](https://princesss-organization.gitbook.io/glospal/)"
    )
    response = "Please feel free to ask me anything."
